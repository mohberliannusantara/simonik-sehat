                ...
                <div class="col-12">
                  <div class="d-flex flex-wrap">
                    <div>
                      ...
                      <h6 class="card-subtitle">preview aktivitas</h6>
                    </div>
                    <div class="ml-auto">
                      <a href="#" rel="tooltip" title="Lihat" class="btn btn-block btn-outline-primary btn-sm">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Moh. Berlian N.</td>
                          <td>
                            <span class="label label-info"><i class="mdi mdi-check"></i> Diterima</span>
                            <span class="label label-danger"><i class="mdi mdi-check"></i> Admedika</span>
                            <span class="label label-warning"><i class="mdi mdi-check"></i> Upload</span>
                            <span class="label label-success"><i class="mdi mdi-check"></i> Keuangan</span>
                          </td>
                        </tr>
                        <tr>
                          <td>0001009603</td>
              ...
              <div class="d-flex">
                <div class="m-r-20 align-self-center">
                  ...
                  <div>
                    ...
                    <h6 class="card-subtitle">Jumlah pegawai terdaftar</h6>
                  </div>
                </div>
                <div class="row">
                  <div class="col-6 align-self-center">
                    <h2 class="font-light text-white"><sup></sup>35487</h2>
                  </div>
              ...
              <div class="card-body">
                <div class="d-flex">
                  <div class="m-r-20 align-self-center">
                    ...
                    <div>
                      <h3 class="card-title">Restitusi</h3>
                      <h6 class="card-subtitle">Jumlah restitusi</h6> </div>
                    </div>
                    <div class="row">
                      <div class="col-6 align-self-center">
                        <h2 class="font-light text-white">1200</h2>
                      </div>
                    ...
                    <div class="row text-center m-t-20">
                      ...
                      <div class="card">
                        <div class="card-body bg-inverse" style="background: url(assets/images/background/user-info.jpg) / cover;">
                          <h4 class="text-white card-title">Pegawai</h4>
                          <h6 class="card-subtitle text-white m-0 op-5">menampilkan preview data pegawai</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="col-lg-8 col-xlg-9">
                              <div class="card">
                                <div class="card-body">
                                  ...
                                  <h6 class="card-subtitle">menampilkan preview data pegawai</h6>
