      ...
      <header class="topbar">
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
          ...
          <div class="navbar-header">
            <a class="navbar-brand" href="<?php echo site_url('kesehatan/beranda') ?>">
              <!-- Logo icon --><b>
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right scale-up">
                            <ul class="dropdown-user">
                              ...
                              <li><a href="<?php echo site_url('kesehatan/restitusi') ?>"><i class="ti-layers"></i> Aktivitas</a></li>
                              <li role="separator" class="divider"></li>
                        ...
                        <ul id="sidebarnav">
                          ...
                          <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                              ...
                              <li><a href="<?php echo site_url('kesehatan/restitusi/create') ?>">Pengajuan Restitusi</a></li>
                              <li><a href="<?php echo site_url('kesehatan/keluarga/create') ?>">Pengajuan Anggota Keluarga</a></li>
                            </ul>
                          </li>
                          <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Aktifitas</span></a>
                            <ul aria-expanded="false" class="collapse">
                              <li><a href="<?php echo site_url('kesehatan/restitusi') ?>">Daftar Permohonan Restitusi</a></li>
                              <li><a href="<?php echo site_url('kesehatan/keluarga') ?>">Daftar Pengajuan Keluarga</a></li>
                            </ul>
                          </li>
                        </ul>
                      </nav>
