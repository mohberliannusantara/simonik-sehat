      ...
      <header class="topbar">
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
          ...
          <div class="navbar-header">
            <a class="navbar-brand" href="<?php echo site_url('sppd/beranda') ?>">
              <!-- Logo icon --><b>
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right scale-up">
                            <ul class="dropdown-user">
                              ...
                              <li><a href="<?php echo site_url('sppd/restitusi') ?>"><i class="ti-layers"></i> Aktivitas</a></li>
                              <li role="separator" class="divider"></li>
                      ...
                      <div class="user-profile">
                        ...
                        <div class="profile-text"> <a href="#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">PT. PLN (Persero) <span class="caret"></span></a>
                          <div class="dropdown-menu animated flipInY">
                            ...
                            <div class="dropdown-divider"></div> <a href="<?php echo base_url('sppd/autentikasi/logout')?>" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                          </div>
                        </div>
                      </div>
                        ...
                        <ul id="sidebarnav">
                          ...
                          <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                              ...
                              <li><a href="<?php echo site_url('sppd/restitusi/create') ?>">Pengajuan Restitusi</a></li>
                              <li><a href="<?php echo site_url('sppd/keluarga/create') ?>">Pengajuan Anggota Keluarga</a></li>
                            </ul>
                          </li>
                          <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Aktifitas</span></a>
                            <ul aria-expanded="false" class="collapse">
                              <li><a href="<?php echo site_url('sppd/restitusi') ?>">Daftar Permohonan Restitusi</a></li>
                              <li><a href="<?php echo site_url('sppd/keluarga') ?>">Daftar Pengajuan Keluarga</a></li>
                            </ul>
                          </li>
                        </ul>
                      </nav>
