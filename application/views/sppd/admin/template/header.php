      ...
      <header class="topbar">
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
          ...
          <div class="navbar-header">
            <a class="navbar-brand" href="<?php echo site_url('sppd/admin/beranda') ?>">
              <!-- Logo icon --><b>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right scale-up">
                    <ul class="dropdown-user">
                      ...
                      <li><a href="<?php echo site_url('sppd/admin/verifikasi') ?>"><i class="ti-layers"></i> Aktivitas</a></li>
                      <li role="separator" class="divider"></li>
                      <li><a href="<?php echo base_url('sppd/autentikasi/logout')?>"><i class="fa fa-power-off"></i> Logout</a></li>
                    </ul>
                  </div>
                </li>
              </ul>
        ...
        <aside class="left-sidebar">
          ...
          <div class="scroll-sidebar">
            ...
            <div class="user-profile">
              ...
              <!-- User profile text-->
              <div class="profile-text"> <a href="<?php echo site_url('sppd/admin/beranda') ?>" role="button" aria-haspopup="true" aria-expanded="true">PT. PLN (Persero)<span class="caret"></span></a>
              </div>
            </div>
              ...
              <ul id="sidebarnav">
                ...
                <li>
                  ...
                  <ul aria-expanded="false" class="collapse">
                    <li><a href="<?php echo site_url('sppd/admin/pegawai') ?>">Daftar Pegawai</a></li>
                    <li><a href="<?php echo site_url('sppd/admin/restitusi') ?>">Daftar SPPD</a></li>
                  </ul>
                </li>
                <li>
                  <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Aktivitas</span></a>
                  <ul aria-expanded="false" class="collapse">
                    <li><a href="<?php echo site_url('sppd/admin/verifikasi') ?>">Daftar Tunggu SPPD</a></li>
                    <!-- <li><a href="<?php echo site_url('sppd/admin/keluarga') ?>">Daftar Pengajuan Keluarga</a></li> -->
                  </ul>
                </li>
                <li>
                  <a class="" href="<?php echo site_url('sppd/admin/laporan') ?>" aria-expanded="false"><i class="mdi mdi-printer"></i><span class="hide-menu">Laporan</span></a>
                </li>
              </ul>
            </nav>
